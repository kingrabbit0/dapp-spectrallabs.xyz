...
!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "485aa669-93f1-42dc-bbb4-227d9470630b"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-485aa669-93f1-42dc-bbb4-227d9470630b"));
  } catch (e) {}
})(),
  (function () {
    try {
      ...
      41391: function (e, t, r) {
        ...
        class x extends HTMLElement {
          ...
          static addInitializer(e) {
            var t;
            this.finalize(),
              (null !== (t = this.h) && void 0 !== t ? t : (this.h = [])).push(
                e
              );
          }
          ...
          requestUpdate(e, t, r) {
            ...
            void 0 !== e &&
              ((
                (r = r || this.constructor.getPropertyOptions(e)).hasChanged ||
                f
              )(this[e], t)
        ...
        (x[y] = !0),
          ...
          null == g || g({ ReactiveElement: x }),
          (null !== (ef = p.reactiveElementVersions) && void 0 !== ef
            ? ef
            : (p.reactiveElementVersions = [])
          ).push("1.6.3");
        let $ = window,
          C = $.trustedTypes,
          _ = C ? C.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
          A = "$lit$",
...
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        function Q(e, t) {
          ...
          return void 0 !== _ ? _.createHTML(t) : t;
        }
        let Y = (e, t) => {
          let r = e.length - 1,
            i = [],
          ...
          for (let t = 0; t < r; t++) {
            ...
            l +=
              a === L
                ? r + k
                : c >= 0
                ? (i.push(n), r.slice(0, c) + A + r.slice(c) + O + h)
                : r + O + (-2 === c ? (i.push(void 0), t) : h);
          }
              ...
              if (1 === i.nodeType) {
                if (i.hasAttributes()) {
                  ...
                  for (let t of i.getAttributeNames())
                    if (t.endsWith(A) || t.startsWith(O)) {
                      let r = c[l++];
                      if ((e.push(t), void 0 !== r)) {
                        let e = i.getAttribute(r.toLowerCase() + A).split(O),
                          t = /([.?@])?(.*)/.exec(r);
                        n.push({
                          type: 1,
                          index: o,
                ...
                if (i.data === E) n.push({ type: 2, index: o });
                else {
                  let e = -1;
                  for (; -1 !== (e = i.data.indexOf(O, e + 1)); )
                    n.push({ type: 7, index: o }), (e += O.length - 1);
                }
              }
              o++;
            }
          ...
          return (
            (null == n ? void 0 : n.constructor) !== s &&
              ...
              void 0 !== i
                ...
                : (r._$Cl = n)),
            void 0 !== n && (t = X(e, n._$AS(e, t.values), n, i)),
            t
          );
        }
        class J {
          ...
          u(e) {
            ...
            for (; void 0 !== s; ) {
              if (a === s.index) {
                let t;
                2 === s.type
                  ? (t = new ee(l, l.nextSibling, this, e))
                  : 1 === s.type
                  ? (t = new s.ctor(l, s.name, s.strings, this, e))
                  : 6 === s.type && (t = new ea(l, this, e)),
                  this._$AV.push(t),
                  (s = i[++n]);
              }
        ...
        class ee {
            ...
            let { values: r, _$litType$: i } = e,
              o =
                "number" == typeof i
                  ? this._$AC(e)
                  : (void 0 === i.el &&
                      (i.el = G.createElement(Q(i.h, i.h[0]), this.options)),
                    i);
            if (
          ...
          T(e) {
            ...
            for (let o of e)
              i === t.length
                ? t.push(
                    (r = new ee(this.k(T()), this.k(T()), this, this.options))
                  )
                : (r = t[i]),
                r._$AI(o),
                i++;
        ...
        class et {
          ...
          _$AI(e, t = this, r, i) {
            ...
            if (void 0 === o)
              (l =
                !P((e = X(this, e, t, 0))) || (e !== this._$AH && e !== V)) &&
                (this._$AH = e);
            else {
              let i, a;
              let n = e;
              for (e = o[0], i = 0; i < o.length - 1; i++)
                (a = X(this, n[r + i], t, i)) === V && (a = this._$AH[i]),
                  l || (l = !P(a) || a !== this._$AH[i]),
                  a === q
                    ? (e = q)
                    : e !== q && (e += (null != a ? a : "") + o[i + 1]),
                  (this._$AH[i] = a);
            }
            l && !i && this.j(e);
          }
        ...
        class eo extends et {
          ...
          j(e) {
            e && e !== q
              ? this.element.setAttribute(this.name, ei)
              : this.element.removeAttribute(this.name);
          }
        }
        class el extends et {
          ...
          _$AI(e, t = this) {
            var r;
            if (
              (e = null !== (r = X(this, e, t, 0)) && void 0 !== r ? r : q) ===
              V
            )
              return;
            let i = this._$AH,
        ...
        null == en || en(G, ee),
          (null !== (eb = $.litHtmlVersions) && void 0 !== eb
            ? eb
            : ($.litHtmlVersions = [])
          ).push("2.8.0");
        let es = (e, t, r) => {
        ...
        class ec extends x {
          ...
          update(e) {
            ...
            this.hasUpdated ||
              ...
              super.update(e),
              (this._$Do = es(t, this.renderRoot, this.renderOptions));
          }
          connectedCallback() {
            var e;
        ...
        (ec.finalized = !0),
          ...
          null === (ey = globalThis.litElementHydrateSupport) ||
            void 0 === ey ||
            ey.call(globalThis, { LitElement: ec });
        let ed = globalThis.litElementPolyfillSupport;
        null == ed || ed({ LitElement: ec }),
            ...
            get: (e, t) => {
              ...
              switch (t) {
                case "duration":
                  return e.duration;
                case "currentTime":
                  return eA.s((null == r ? void 0 : r[t]) || 0);
                case "playbackRate":
                case "playState":
                ...
                case "finished":
                  return (
                    e.finished ||
                      (e.finished = Promise.all(e.animations.map(eS)).catch(
                        eO
                      )),
                    e.finished
                  );
        ...
        let td = (e, t) => {
            ...
            for (let t = 0; t < i; t++) r += e(ej(0, i - 1, t)) + ", ";
        ...
        let tw = {
          ...
          tf = function (e, t, r = {}) {
            ...
            eG(!!a, "No valid element provided."),
                  ...
                  return (
                    ...
                    () => {
                      ...
                      if (
                          ...
                          (tc.cssRegisterProperty()
                            ? (function (e) {
                                if (!tl.has(e)) {
                                  tl.add(e);
                                  try {
                                    let { syntax: t, initialValue: r } = e3.has(
                                      e
                                    )
                                      ? e3.get(e)
                                      : {};
                        ...
                        _ &&
                          (b = b.map((e) => (eL(e) ? _.toDefaultUnit(e) : e))),
                          1 === b.length &&
                        ...
                        let t = b[b.length - 1];
                        tw.set(e, $, _ && eL(t) ? _.toDefaultUnit(t) : t);
                      }
                      return (
                        s &&
                          n(
        ...
        var tx = r(92592),
          ...
          tO = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          tE = (e, t) => {
            for (var r in t || (t = {})) t_.call(t, r) && tO(e, r, t[r]);
            if (tC) for (var r of tC(t)) tA.call(t, r) && tO(e, r, t[r]);
            return e;
          };
        function tk() {
          return {
        ...
        let tR = class extends ec {
          ...
          render() {
            ...
            return (
              ...
              Z`<button class="${ev(e)}" ?disabled="${this.disabled}" @click="${
                this.onClick
              }">${
                this.iconLeft
        ...
        (tR.styles = [tI.globalCss, tT]),
          tS([eu({ type: Boolean })], tR.prototype, "disabled", 2),
          tS([eu()], tR.prototype, "iconLeft", 2),
          tS([eu()], tR.prototype, "iconRight", 2),
          tS([eu()], tR.prototype, "onClick", 2),
          tS([eu()], tR.prototype, "variant", 2),
          (tR = tS([eh("wcm-button")], tR));
        ...
        let tN = class extends ec {
          ...
          render() {
            ...
            return Z`<button ?disabled="${this.disabled}" class="${ev(
              e
            )}"><slot></slot></button>`;
          }
        };
        (tN.styles = [tI.globalCss, tL]),
          tj([eu({ type: Boolean })], tN.prototype, "disabled", 2),
          tj([eu()], tN.prototype, "variant", 2),
          (tN = tj([eh("wcm-button-big")], tN));
        ...
        var t4 = Object.defineProperty,
          ...
          t7 = (e, t, r, i) => {
            for (
              var o, l = i > 1 ? void 0 : i ? t3(t, r) : t, a = e.length - 1;
              a >= 0;
              a--
            )
              (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          ...
          render() {
            let e = { "wcm-border": this.border },
              ...
              r = this.title
                ...
                : Z`<slot></slot>`;
            return Z`<header class="${ev(e)}">${
              t ? this.backBtnTemplate() : null
            } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
          }
        };
        (t6.styles = [tI.globalCss, t5]),
          t7([eu()], t6.prototype, "title", 2),
          t7([eu()], t6.prototype, "onAction", 2),
          t7([eu()], t6.prototype, "actionIcon", 2),
          t7([eu({ type: Boolean })], t6.prototype, "border", 2),
          (t6 = t7([eh("wcm-modal-header")], t6));
        let t8 = {
            ...
            caseSafeIncludes: (e, t) =>
              e.toUpperCase().includes(t.toUpperCase()),
        ...
        (ri.styles = [tI.globalCss, t9]),
          rr([ew()], ri.prototype, "view", 2),
          rr([ew()], ri.prototype, "prevView", 2),
          (ri = rr([eh("wcm-modal-router")], ri));
        ...
        (rs.styles = [tI.globalCss, ro]),
          rn([ew()], rs.prototype, "open", 2),
          (rs = rn([eh("wcm-modal-toast")], rs));
        let rd = {
            generate(e, t, r) {
              let i = "#141414",
                o = [],
        ...
        let rw = class extends ec {
          ...
          svgTemplate() {
            let e =
              "light" === eC.ThemeCtrl.state.themeMode
                ? this.size
                : this.size - 36;
            return B`<svg height="${e}" width="${e}">${rd.generate(
              this.uri,
              e,
              e / 4
            )}</svg>`;
          ...
          render() {
            ...
            return Z`<div style="${`width: ${this.size}px`}" class="${ev(e)}">${
              this.walletId || this.imageUrl
                ? Z`<wcm-wallet-image walletId="${ty(
                    this.walletId
        ...
        (rw.styles = [tI.globalCss, rh]),
          ru([eu()], rw.prototype, "uri", 2),
          ru([eu({ type: Number })], rw.prototype, "size", 2),
          ru([eu()], rw.prototype, "imageId", 2),
          ru([eu()], rw.prototype, "walletId", 2),
          ru([eu()], rw.prototype, "imageUrl", 2),
          (rw = ru([eh("wcm-qrcode")], rw));
        ...
        (ry.styles = [tI.globalCss, rg]),
          rb([eu()], ry.prototype, "onChange", 2),
          (ry = rb([eh("wcm-search-input")], ry));
        ...
        (rI.styles = [tI.globalCss, rA]),
          rk([eu()], rI.prototype, "variant", 2),
          rk([eu()], rI.prototype, "color", 2),
          (rI = rk([eh("wcm-text")], rI));
        ...
        (rR.styles = [tI.globalCss, rT]),
          rS([eu()], rR.prototype, "onClick", 2),
          rS([eu()], rR.prototype, "name", 2),
          rS([eu()], rR.prototype, "walletId", 2),
          rS([eu()], rR.prototype, "label", 2),
          rS([eu()], rR.prototype, "imageId", 2),
          rS([eu({ type: Boolean })], rR.prototype, "installed", 2),
          rS([eu({ type: Boolean })], rR.prototype, "recent", 2),
          (rR = rS([eh("wcm-wallet-button")], rR));
        ...
        let rN = class extends ec {
          ...
          render() {
            ...
            return Z`${
              t.length
                ? Z`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
                : tB.WALLET_PLACEHOLDER
            }`;
          }
        };
        (rN.styles = [tI.globalCss, rL]),
          rj([eu()], rN.prototype, "walletId", 2),
          rj([eu()], rN.prototype, "imageId", 2),
          rj([eu()], rN.prototype, "imageUrl", 2),
          (rN = rj([eh("wcm-wallet-image")], rN));
        ...
        rH([ew()], rZ.prototype, "preload", 2),
          (rZ = rH([eh("wcm-explorer-context")], rZ));
        ...
        let rY = class extends ec {
          ...
          render() {
            ...
            return Z`<wcm-modal-header title="Connect your wallet" .onAction="${
              ...
              let i = t[r % t.length];
              return i
                ? Z`<wcm-wallet-image walletId="${i.id}" imageId="${i.image_id}"></wcm-wallet-image>`
                : tB.WALLET_PLACEHOLDER;
        ...
        (r1.styles = [tI.globalCss, rG]),
          r0([eu()], r1.prototype, "walletId", 2),
          r0([eu()], r1.prototype, "imageId", 2),
          r0([eu({ type: Boolean })], r1.prototype, "isError", 2),
          r0([eu({ type: Boolean })], r1.prototype, "isStale", 2),
          r0([eu()], r1.prototype, "label", 2),
          (r1 = r0([eh("wcm-connector-waiting")], r1));
        let r2 = {
            manualWallets() {
              var e, t;
          ...
          r5 = {
            ...
            manualWalletsTemplate() {
              return r2
                ...
                .map(
                  (e) =>
                    Z`<wcm-wallet-button walletId="${e.id}" name="${
                      e.name
                    }" .onClick="${() =>
            ...
            recomendedWalletsTemplate(e = !1) {
              return r2
                ...
                .map(
                  (e) =>
                    Z`<wcm-wallet-button name="${e.name}" walletId="${
                      e.id
            ...
            recentWalletTemplate() {
              ...
              if (e)
                return Z`<wcm-wallet-button name="${e.name}" walletId="${
                  e.id
        ...
        let ih = class extends ec {
            ...
            this.toggleBodyScroll(!1),
              ...
              setTimeout(async () => {
                ...
                await Promise.all([
                  ...
                  tb(this.containerEl, e, { delay: 0.1, duration: 0.2 })
                    .finished,
                ]),
                  (this.active = !0);
              }, 0);
          ...
          async onCloseModalEvent() {
            ...
            let e = t8.isMobileAnimation()
              ...
              : { scale: [1, 0.98] };
            await Promise.all([
              tb(this.overlayEl, { opacity: [1, 0] }, { duration: 0.2 })
                .finished,
          ...
          render() {
            ...
            return Z`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${ev(
              e
            )}" @click="${
              this.onCloseModal
        ...
        (ih.styles = [tI.globalCss, ia]),
          id([ew()], ih.prototype, "open", 2),
          id([ew()], ih.prototype, "active", 2),
          (ih = id([eh("wcm-modal")], ih));
        ...
        let ig = class extends ec {
          ...
          render() {
            return Z`<div>${this.isRetry ? Z`<slot></slot>` : null} ${
              this.isMobile
                ? Z`<wcm-button .onClick="${this.onMobile}" .iconLeft="${tB.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
                : null
            } ${
              this.isDesktop
                ? Z`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${tB.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
                : null
            } ${
              this.isWeb
                ? Z`<wcm-button .onClick="${this.onWeb}" .iconLeft="${tB.GLOBE_ICON}" variant="outline">Web</wcm-button>`
                : null
            }</div>`;
          }
        };
        (ig.styles = [tI.globalCss, im]),
          iw([eu({ type: Boolean })], ig.prototype, "isMobile", 2),
          iw([eu({ type: Boolean })], ig.prototype, "isDesktop", 2),
          iw([eu({ type: Boolean })], ig.prototype, "isWeb", 2),
          iw([eu({ type: Boolean })], ig.prototype, "isRetry", 2),
          (ig = iw([eh("wcm-platform-selection")], ig));
        ...
        let ix = class extends ec {
          ...
          render() {
            ...
            return Z`<button @click="${
              ...
              if (t) return Z`<img crossorigin="anonymous" src="${t}">`;
        ...
        (iO.styles = [tI.globalCss, i$]),
          iA([eu()], iO.prototype, "walletId", 2),
          iA([eu()], iO.prototype, "imageId", 2),
          iA([ew()], iO.prototype, "uri", 2),
          (iO = iA([eh("wcm-walletconnect-qr")], iO));
        ...
        let iR = class extends ec {
          ...
          render() {
            ...
            return Z`<wcm-modal-header title="${e}" .onAction="${
              t8.handleUriCopy
            }" .actionIcon="${
              tB.COPY_ICON
        ...
        (iR.styles = [tI.globalCss, iT]),
          iS([ew()], iR.prototype, "isError", 2),
          (iR = iS([eh("wcm-desktop-connecting-view")], iR));
        ...
        let ij = class extends ec {
          ...
          render() {
            ...
            return Z`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(
              r
        ...
        (iZ.styles = [tI.globalCss, iN]),
          iH([ew()], iZ.prototype, "isError", 2),
          (iZ = iH([eh("wcm-mobile-connecting-view")], iZ));
        ...
        let i1 = class extends ec {
          constructor() {
            super(...arguments),
              ...
              (this.firstFetch =
                !eC.ExplorerCtrl.state.wallets.listings.length),
              (this.search = ""),
              (this.endReached = !1),
          ...
          async fetchWallets() {
            ...
            if (
              !this.endReached &&
              (this.firstFetch || (o > 40 && i.length < o))
            )
              try {
                this.loading = !0;
                let t =
          ...
          render() {
            ...
            return Z`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
              ...
              i
                ...
                : r.map(
                    (e) =>
                      Z`${
                        e
                          ? Z`<wcm-wallet-button imageId="${
                              e.image_id
                            }" name="${e.name}" walletId="${
                              e.id
                            }" .onClick="${() =>
              ...
              !n && this.loading ? Z`<wcm-spinner></wcm-spinner>` : null
            }</div></wcm-modal-content>`;
          }
        };
        (i1.styles = [tI.globalCss, iG]),
          i0([ew()], i1.prototype, "loading", 2),
          i0([ew()], i1.prototype, "firstFetch", 2),
          i0([ew()], i1.prototype, "search", 2),
          i0([ew()], i1.prototype, "endReached", 2),
          (i1 = i0([eh("wcm-wallet-explorer-view")], i1));
        ...
        (i7.styles = [tI.globalCss, i2]),
          i3([ew()], i7.prototype, "isError", 2),
          (i7 = i3([eh("wcm-web-connecting-view")], i7));
      },
    },
  ]);
